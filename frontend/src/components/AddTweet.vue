<template>
  <div class="add-tweet-root">
    ...
    <div class="add-tweet-section2">
      <textarea
        v-if="cevent != 'editTweet'"
        v-model="$store.state.newTweet.text"
        :placeholder="p || ` What's happening?`"
        maxlength="280"
      ></textarea>
      <img
      ...
      <input
        v-model="$store.state.newTweet.image"
        type="text"
        placeholder="Image URL"
      />
      <div class="bottom-tool-bar">
        <TwitterButton
          :click-event="cevent || 'addNewTweet'"
          h="40px"
          w="75px"
          br="20px"
          :text="btntext || 'Tweet'"
